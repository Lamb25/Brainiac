; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29914.0 
	...
	TITLE	C:\TouchGFXProjects\Brainiac\build\Debug\obj\UnmappedDataFont.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__EE1B539A_UnmappedDataFont@hpp DB 01H
__ACAD51FD_FontManager@hpp DB 01H
__9B17B790_ApplicationFontProvider@hpp DB 01H
__84574E86_FlashDataReader@hpp DB 01H
__9D2259E7_UnmappedDataFont@cpp DB 01H
msvcjmc	ENDS
...
; File C:\TouchGFXProjects\Brainiac\generated\fonts\include\fonts\ApplicationFontProvider.hpp
; Line 37
	push	ebp
	mov	ebp, esp
	...
	rep stosd
	mov	ecx, OFFSET __9B17B790_ApplicationFontProvider@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\Brainiac\generated\fonts\src\UnmappedDataFont.cpp
; Line 69
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __9D2259E7_UnmappedDataFont@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 70
...
; _this$ = ecx
; File C:\TouchGFXProjects\Brainiac\generated\fonts\include\fonts\UnmappedDataFont.hpp
; Line 90
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __EE1B539A_UnmappedDataFont@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 91
	mov	eax, DWORD PTR _this$[ebp]
