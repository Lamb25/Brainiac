; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29914.0 
	...
	TITLE	C:\TouchGFXProjects\Brainiac\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__E934C1FC_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1JO@EEPHNPHC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1JO@EEPHNPHC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1JO@EEPHNPHC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
...
; _this$ = ecx
; File C:\TouchGFXProjects\Brainiac\generated\fonts\include\fonts\CachedFont.hpp
; Line 60
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __7F1E2764_CachedFont@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\Brainiac\generated\fonts\src\FontCache.cpp
; Line 372
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __E934C1FC_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 373
	mov	eax, DWORD PTR _this$[ebp]
...
tv158 = -348						; size = 4
$T2 = -340						; size = 48
_gsubPosition$3 = -92					; size = 4
_sizeOfGSUB$4 = -80					; size = 4
...
; Line 96
	...
	mov	DWORD PTR _sizeOfGSUB$4[ebp], edx
; Line 97
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+40]
	add	ecx, DWORD PTR _sizeOfGSUB$4[ebp]
	mov	edx, DWORD PTR _this$[ebp]
...
; Line 99
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+44]
	sub	ecx, DWORD PTR _sizeOfGSUB$4[ebp]
	mov	DWORD PTR _gsubPosition$3[ebp], ecx
; Line 100
	mov	eax, DWORD PTR _sizeOfGSUB$4[ebp]
	push	eax
	mov	ecx, DWORD PTR _gsubPosition$3[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?readData@FontCache@touchgfx@@AAEXPAXI@Z ; touchgfx::FontCache::readData
; Line 101
	mov	esi, esp
	mov	eax, DWORD PTR _gsubPosition$3[ebp]
	push	eax
	mov	ecx, DWORD PTR _font$[ebp]
...
$LN3@assertVali:
	mov	esi, esp
	push	177					; 000000b1H
	push	OFFSET ??_C@_1JO@EEPHNPHC@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
